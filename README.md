...
Об авторе
Я Deluxo31, фронтенд-разработчик. Обожаю готовить (и есть), а ещё экспериментировать с технологиями. Этот проект собрал, чтобы объединить два хобби. Буду рад, если кому-то пригодится.
